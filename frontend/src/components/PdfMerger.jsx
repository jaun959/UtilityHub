  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={onSubmit}>
        <div className="mb-4">
          <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlFor="multiple_files">Upload multiple PDF files</label>
      ...
      {convertedFile && (
        <div className="mt-4">
          ...
          <a href={convertedFile.path} download className="text-blue-500 hover:underline">Download Merged PDF</a>
        </div>
      )}
    </div>
  );
